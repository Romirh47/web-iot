                ...
                <div class="sign-in-from">
                    ...
                    <form class="mt-4" action="{{route('register')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="name" type="text" class="form-control mb-0" id="exampleInputEmail1" placeholder="masukan nama lengkap">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputEmail2">Alamat Email</label>
                            <input name="email" type="email" class="form-control mb-0" id="exampleInputEmail2" placeholder="masukan email">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="password_confirmation" type="password" class="form-control mb-0" id="password_confirmation" placeholder="ulangi password">
                        </div>
