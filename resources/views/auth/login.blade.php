                ...
                <div class="sign-in-from">
                    ...
                    <form class="mt-4" action="{{route('login')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="email" type="email" class="form-control mb-0" id="exampleInputEmail1" placeholder="masukan email">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="d-inline-block w-100">
                            <div class="custom-control custom-checkbox d-inline-block mt-2 pt-1">
                                <input name="remeber" type="checkbox" class="custom-control-input" id="customCheck1">
                                <label class="custom-control-label" for="customCheck1">ingatkan saya</label>
                            </div>
                            <button type="submit" class="btn btn-primary float-right">login</button>
                        </div>
                        <div class="sign-info">
                            <span class="dark-color d-inline-block line-height-2">belum punya akun? <a href="{{route('register')}}">daftar</a></span>
                            <ul class="iq-social-media">
                                <li><a href="https://x.com/romirh47"><i class="ri-twitter-line"></i></a></li>
                                <li><a href="https://www.instagram.com/roomierh"><i class="ri-instagram-line"></i></a></li>
                            </ul>
                        </div>
                    </form>
                </div>
